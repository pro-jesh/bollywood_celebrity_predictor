...
results = detector.detect_faces(sample_img) #we have to detect faces from the image
...
face_array = face_array.astype('float32') #we need to convert the array to float datatype
